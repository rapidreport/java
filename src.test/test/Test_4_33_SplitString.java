...
public class Test_4_33_SplitString {
    ...
    private static DataTable getDataTable() throws Throwable {
		...
		ret.addRecord().puts("遠野郷は今の陸中上閉伊郡の西の半分、山々にて取り囲かこまれたる平地なり。\n" +
				"新町村にては、遠野、土淵、附馬牛、松崎、青笹、上郷、小友、綾織、鱒沢、宮守、達曾部の一町十ヶ村に分かつ。\n" +
				"近代或いは西閉伊郡とも称し、中古にはまた遠野保とも呼べり。今日郡役所のある遠野町はすなわち一郷の町場にして、南部家一万石の城下なり。\n" +
				"城を横田城ともいう。\n" +
				"この地へ行くには花巻の停車場にて汽車を下おり、北上川を渡り、その川の支流猿さるヶ石川の渓を伝いて、東の方へ入ること十三里、遠野の町に至る。\n" +
				"山奥には珍しき繁華の地なり。伝えいう、遠野郷の地大昔はすべて一円の湖水なりしに、その水猿ヶ石川となりて人界に流れ出でしより、自然にかくのごとき邑落をなせしなりと。\n" +
				"されば谷川のこの猿ヶ石に落合うもの甚はなはだ多く、俗に七内八崎ありと称す。内は沢または谷のことにて、奥州の地名には多くあり。");
		ret.addRecord().puts("遠野の町は南北の川の落合にあり。\n" +
				"以前は七七十里とて、七つの渓谷おのおの七十里の奥より売買の貨物を聚め、その市の日は馬千匹、人千人の賑わしさなりき。\n" +
				"四方の山々の中に最も秀でたるを早池峯という、北の方附馬牛の奥にあり。東の方には六角牛山立てり。石神という山は附馬牛と達曾部との間にありて、その高さ前の二つよりも劣れり。\n" +
		...
		ret.addRecord().puts("山々の奥には山人住めり。栃内村和野の佐々木嘉兵衛という人は今も七十余にて生存せり。\n" +
				"この翁若かりしころ猟をして山奥に入りしに、遥かなる岩の上に美しき女一人ありて、長き黒髪を梳りていたり。\n" +
				"顔の色きわめて白し。不敵の男なれば直に銃を差し向けて打ち放せしに弾に応じて倒れたり。\n" +
